...
Aprendendo um pouco sobre MYSQL:
...
CREATE TABLE tbl_genres (
    ...
    genres ENUM('Action', 'Comedy', 'Science Fiction', 'Romance', 'Thriller', 'Horror','Musical', 'Educational', 'Help Self','Children'),
    idfk_videos INT,
...
mysql> SELECT name, gender, title, pub_date
    -> from tbl_author
    -> inner join tbl_videos
    -> on id_author = idfk_author;
+------------------+--------+---------------------+------------+
...
| Franklin Moura   | M      | Musical film        | 2018-04-13 |
| Franklin Moura   | M      | Comedy Film         | 2017-05-19 |
| Franklin Moura   | M      | Comedy Film         | 2017-05-19 |
...
| Claudia Oliveira | OTHER  | Help Self bla bla   | 2018-09-10 |
| Claudia Oliveira | OTHER  | Learning IA         | 2021-07-09 |
| Rodrigo Ruwer    | M      | Learning HTML 5     | 2019-11-18 |
+------------------+--------+---------------------+------------+
...
mysql> SELECT title, pub_date, likes, dislikes, times_watched , name, gender, genres
    -> from tbl_videos
    -> inner join tbl_author
    -> on id_author = idfk_author
    -> inner join tbl_genres
...
| Help Self bla bla   | 2018-09-10 | 190000 |      300 |       1566000 | Claudia Oliveira | OTHER  | Help Self   |
| Learning IA         | 2021-07-09 | 121000 |     2450 |      14590000 | Claudia Oliveira | OTHER  | Educational |
| Learning Cobol      | 2020-06-02 |  90000 |     2456 |     355660000 | Jorge Alvez      | M      | Educational |
| Learning HTML 5     | 2019-11-18 | 120000 |     1200 |      13450000 | Rodrigo Ruwer    | M      | Educational |
...
| Learning DJANGO     | 2020-08-13 | 150000 |     3200 |      11199000 | Lucia Maria      | F      | Educational |
| Test Horror         | 2019-03-01 |  15600 |      900 |       3000589 | Lucia Maria      | F      | Horror      |
| Musical film        | 2018-04-13 | 180000 |      200 |      35900098 | Franklin Moura   | M      | Musical     |
| Comedy Film         | 2017-05-19 | 113000 |     1000 |     458900034 | Franklin Moura   | M      | Comedy      |
| Comedy Film         | 2017-05-19 |  11000 |     1000 |     457910034 | Franklin Moura   | M      | Comedy      |
+---------------------+------------+--------+----------+---------------+------------------+--------+-------------+
15 rows in set (0.00 sec)
...
Como fazer backup da base de dados via command line:  mysqldump mysql -u root -pyourpassword --databases dio_mysql > dio_mysql.sql
